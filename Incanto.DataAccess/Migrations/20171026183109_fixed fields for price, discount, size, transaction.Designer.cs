...
namespace Incanto.DataAccess.Migrations
{
    ...
    [Migration("20171026183109_fixed fields for price, discount, size, transaction")]
    partial class fixedfieldsforpricediscountsizetransaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Incanto.Domain.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransctionTime");
            ...
            modelBuilder.Entity("Incanto.Domain.Transaction", b =>
                {
                    b.HasOne("Incanto.Domain.ExistingItem", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId");
                });
